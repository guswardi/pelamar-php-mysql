        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Pembayaran SSB</h4>
            ...
            <form method="post" enctype="multipart/form-data" action="add/tambah_pembayaran.php">
                ...
                <div class="form-group">
                  <label for="formGroupExampleInput2">Nama Siswa SSB</label>
                  <input type="text" class="form-control"  value="<?php echo $_POST['mhs'];?>" name="nama" readonly>
                </div>
                <div class="form-group">
                  <label for="formGroupExampleInput2">Jenis Pembayaran SSB</label>
                ...
                <div class="form-group" id='list-smt' style='display:none;'>
                  ...
                  <table width='100%'>
                    <tr>
                      <td><input type="checkbox"  name="detail[]" value='1'>BULAN  1</td>
                      <td><input type="checkbox"  name="detail[]" value='3'>BULAN  3</td>
                      <td><input type="checkbox"  name="detail[]" value='5'>BULAN  5</td>
                      <td><input type="checkbox"  name="detail[]" value='7'>BULAN  7</td> 
                      <td><input type="checkbox"  name="detail[]" value='9'>BULAN  9</td>
                      <td><input type="checkbox"  name="detail[]" value='11'>BULAN 11</td>                      
                    </tr>
                    <tr>
                      <td><input type="checkbox"  name="detail[]" value='2'>BULAN  2</td>
                      <td><input type="checkbox"  name="detail[]" value='4'>BULAN  4</td>
                      <td><input type="checkbox"  name="detail[]" value='6'>BULAN  6</td>
                      <td><input type="checkbox"  name="detail[]" value='8'>BULAN  8</td>  
                      <td><input type="checkbox"  name="detail[]" value='10'>BULAN 10</td>
                      <td><input type="checkbox"  name="detail[]" value='12'>BULAN 12</td>                    
                    </tr>
                  </table>
