        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Pembayaran SSB Sumber Barokah</h4>
      ...
      <!-- List Tagihan -->
                <table id="view-pemb" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $jml = 0;
                    $npm = $_SESSION['noId'];
                    $query = mysqli_query($koneksi,"SELECT * FROM tb_tagihan WHERE npm='$npm' AND status='0'");
                    while($mhs = mysqli_fetch_array($query)){
                      $no++
                    ?>
                  <tr>
                    <td width='5%'><input type="checkbox" name='nilai[]' onclick="UpdateCost(this);" value="<?php echo $mhs['nilai'];?>"></td>
                    <td><?php echo $mhs['npm'];?></td>
                    <td><?php echo $mhs['nama'];?></td>
                    <td><input type="text"name='jenis[]' value='<?php echo $mhs['jenis'];?>' hidden><?php echo $mhs['jenis'];?></td>
                    <td><input type="text"name='detail[]' value='<?php echo $mhs['detail'];?>' hidden><?php echo $mhs['detail'];?></td>
                    <td align='right'><?php echo $mhs['nilai'];?></td>
                    <td align='right'><input type="text" name='nota[]' value='<?php echo $mhs['nota'];?>' hidden><?php echo $mhs['nota'];?></td>
                  </tr>
                  <?php
                ...
                $jml += $mhs['nilai'];}?>                 
                  ...
                  <tr>
                    ...
                    <th></th>
                    <th></th>
                    <th colspan=2 class='text-right'>Rp. <?php echo $jml++;?></th>
                  </tr>
                  </tfoot>
    </table>
    <!-- End Of List Tagihan -->
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="jumlah" id='jumlah' value='0' oninput="calculate()" hidden>
                </div>
                <div class="form-group">
